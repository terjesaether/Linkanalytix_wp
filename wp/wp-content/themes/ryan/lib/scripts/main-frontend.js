					...
					jQuery( this ).find( '#' + instanceID + '-inner' ).carouFredSel({
						...
						onCreate: function () {
							jQuery(window).bind("load resize", function() {
								...
								var parentWidthTestimonial = null;
								jQuery( '#' + instanceID + '.carousel-testimonial.style1' ).children().each(function(){
									parentWidthTestimonial = parentWidthTestimonial + jQuery(this).outerHeight(true);
								});
								jQuery( '#' + instanceID + '.carousel-testimonial.style1' ).height( parentWidthTestimonial );

								// Set height to testimonial carousel elements - Not Style 1
								var parentWidthTestimonial = null;
								parentWidthTestimonial = jQuery( '#' + instanceID + '.carousel-testimonial li').outerHeight();
								jQuery( '#' + instanceID + '.carousel-testimonial:not(.style1)' ).height( 'auto' );
								jQuery( '#' + instanceID + '.carousel-testimonial:not(.style1) .caroufredsel_wrapper' ).css( { 'height': parentWidthTestimonial } );
